...
var passport = require('passport-strategy')
  ...
  , NullStore = require('passport-oauth2/lib/state/null')
  , NonceStore = require('passport-oauth2/lib/state/session')
  , StateStore = require('passport-oauth2/lib/state/store')
  , PKCEStateStore = require('passport-oauth2/lib/state/pkcesession')
  ...
  , InternalOAuthError = require('passport-oauth2/lib/errors/internaloautherror');
